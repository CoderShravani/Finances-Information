...
def css():
    ...
    /* Force ALL Streamlit text-input surfaces to WHITE, including mobile dark-mode */
    :root {
    ...
    /* Explicit white field background for every widget generated by the form */
    [data-testid="stTextInput"] [role="textbox"],
    [data-testid="stTextArea"] [role="textbox"] {
        background-color:#ffffff !important;
        background:#ffffff !important;
        color:#15233b !important;
        -webkit-text-fill-color:#15233b !important;
